...
call s:h("Conditional", { "fg": s:blue, "cterm": "bold" }) " if, then, else, endif, switch, etc.
call s:h("Repeat", { "fg": s:blue, "cterm": "bold" }) " for, do, while, etc.
call s:h("Label", { "fg": s:blue, "cterm": "bold" }) " case, default, etc.
