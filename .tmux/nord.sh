...
set-window-option -g window-status-style fg=$nord01,bg=$base00
set-window-option -g window-status-format " #I #W"

# active window title colors
set-window-option -g window-status-current-style fg=$nord00,bg=$base00
...
tm_session_name="#[default,bg=$base00,fg=$nord01] #S "
set -g status-left "$tm_session_name"

tm_date="#[default,bg=$base00,fg=$base0C] %R"
tm_host="#[fg=$nord01,bg=$base00] #h "
